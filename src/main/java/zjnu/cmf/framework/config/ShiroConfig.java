...
import zjnu.cmf.framework.shiro.realm.UserRealm;
import zjnu.cmf.framework.shiro.session.OnlineSessionDAO;
import zjnu.cmf.framework.shiro.session.OnlineSessionFactory;
import zjnu.cmf.framework.shiro.web.filter.LogoutFilter;
import zjnu.cmf.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import zjnu.cmf.framework.shiro.web.filter.online.OnlineSessionFilter;
import zjnu.cmf.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import zjnu.cmf.framework.shiro.web.session.OnlineWebSessionManager;
import zjnu.cmf.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig
{
    ...
    {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("cmf");
